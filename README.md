...
Whatsapp service to send message
...
This feature used to create sender session, returns QR code data URL.
...
This feature used to find existing sender session, returns message when exists.
...
```json
{
  "message": "Session +621234567890 already exists"
}
```

- Delete Session

This feature used to delete existing sender session, returns empty.
...
This feature used to get persons in sender whatsapp contact, returns persons data.
...
This feature used to send message from sender to person, returns message.
...
This feature used to send bulk messages from sender to persons, returns message.
...
This feature used to get groups in sender whatsapp contact, returns groups data.
...
This feature used to send message from sender to group, returns message.
...
This feature used to send bulk messages from sender to groups, returns message.
